...
LOCALE_PATHS = [
    '/home/doncandid/code/mysite/floran/locale'
]
...
WAGTAILADMIN_RICH_TEXT_EDITORS = {
    'default': {
        ...
        'OPTIONS': {
            'features': ['h2', 'h3', 'h4', 'bold', 'italic', 'link', 'code', 'document-link', 'blockquote', 'ol', 'ul', 'hr', 'superscript', 'subscript', 'strikethrough']
        }
    },
    'secondary': {
